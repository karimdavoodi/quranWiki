        ...
        <>
            ...
            <div className="text-xs2 text-left p-3 text-white">
                <div className="pt-3">
                    ...
                    We think by finding the relation between each Quran verse
                    and Hadith and Bible, we can understand it better. If you
                    agree, Please help us by making the connection between
                    texts, By icons below each verse.
